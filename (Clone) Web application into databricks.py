...
# MAGIC %md
# MAGIC
# MAGIC # Notebook to execute a web application for data scientist (streamlit or Gradio)
# MAGIC IN WORKING

# COMMAND ----------

# MAGIC %md
# MAGIC ## Install package and generate utils proxy function

# COMMAND ----------

# MAGIC %pip install uvicorn fastapi gradio streamlit
